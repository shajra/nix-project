#+title: Flakes Basics Development Guide
...
third-party support like [[nix-flakes-utils][=flake-utils=]] or [[nix-flakes-parts][=flake-parts=]].  A [[file:project-developing-modules.org][separate document]]
covers modular development with flakes, specifically with =flake-parts=.
...
- =less=: uses Nix flakes directly without projects like [[nix-flakes-utils][flake-utils]] or
  [[nix-flakes-parts][flake-parts]]
- =more=: uses flakes with more third-party support like [[nix-flakes-parts][flake-parts]].
