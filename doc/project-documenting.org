...
** Controlling the environment with =org2gfm-hermetic=

The Nix-project flake exports at =#lib.<system>.org2gfm-hermetic= a function you
can use to wrap the =org2gfm= script with another script to tightly control the
environment =org2gfm= executes in.

See the [[file:../nix/org2gfm-hermetic.nix][comments in the source code]] for details on how to call this function.
...
=org2gfm=hermetic= tailored to your needs.
