...
Though the latest version of Nix is Nix 2.35.2, we'll be installing the version that the last release of NixOS (26.05) uses, specifically Nix 2.34.8. As discussed in the included [introduction to Nix](nix-introduction.md), this version is considered stable by the Nix community.
