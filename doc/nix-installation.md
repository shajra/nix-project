...
Since the latest release of Nix is already at 2.17, if you installed Nix recently as per the instructions above, you should be on a recent-enough version:
