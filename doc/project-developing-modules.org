...
Specifically, it explains how to author [[nix-flakes-parts][=flake-parts=]] modules, to address some
points of tension when using the plain flakes API.
...
configure [[treefmt-nix][=treefmt-nix=]], we can import the [[nix-flakes-parts-doc-treefmt][=treefmt-nix= flake module]].  This
...
high-level.  You should eventually read the [[nix-flakes-parts-doc][official =flake-parts= documentation]].
...
attribute set above). These top-level module arguments are [[nix-flakes-parts-doc-modargs][documented fully in
...
The per-system module arguments are also [[nix-flakes-parts-doc-modargs][documented fully in the flake-parts
...
See the [[nix-flakes-parts-doc-modargs][official flake-parts documentation]] for more per-system module arguments
...
- [[nix-flakes-parts-doc][=flake-parts= documentation]]
- [[nixos-manual-modules][The NixOS manual's section on modules]]
